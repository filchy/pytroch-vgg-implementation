...
class VGG16(nn.Module):
    def __init__(self):
        ...
        self.triple_conv_1 = TripleConv(128, 256)
        self.triple_conv_2 = TripleConv(256, 512)
        self.triple_conv_3 = TripleConv(512, 512)
    ...
    def forward(self, x):
        ...
        x3 = self.triple_conv_1(x2)
        x4 = self.triple_conv_2(x3)
        x5 = self.triple_conv_3(x4)
